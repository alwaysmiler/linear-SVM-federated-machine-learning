...
class TFML:
    ...
    def dataProcess(self):
        datafolder = r'C:\Users\tingx\Downloads\MeasurementsFromAgnesDevices\Agnes-3'
        ...
        y_datalist = [0] * int(len(ResultFLUO25) / 2) + [1] * int(len(ResultFLUO50) / 2) + [2] * int(len(ResultFLUO75) / 2) + [3] * int(len(ResultFLUO100) / 2)
